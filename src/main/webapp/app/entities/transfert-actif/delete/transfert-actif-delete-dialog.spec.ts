...
import { TransfertActifDeleteDialog } from './transfert-actif-delete-dialog';

describe('TransfertActif Management Delete Component', () => {
  let comp: TransfertActifDeleteDialog;
  let fixture: ComponentFixture<TransfertActifDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TransfertActifDeleteDialog);
