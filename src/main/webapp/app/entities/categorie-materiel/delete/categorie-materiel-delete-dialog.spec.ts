...
import { CategorieMaterielDeleteDialog } from './categorie-materiel-delete-dialog';

describe('CategorieMateriel Management Delete Component', () => {
  let comp: CategorieMaterielDeleteDialog;
  let fixture: ComponentFixture<CategorieMaterielDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CategorieMaterielDeleteDialog);
