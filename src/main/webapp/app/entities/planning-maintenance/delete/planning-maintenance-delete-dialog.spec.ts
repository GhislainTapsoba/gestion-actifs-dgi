...
import { PlanningMaintenanceDeleteDialog } from './planning-maintenance-delete-dialog';

describe('PlanningMaintenance Management Delete Component', () => {
  let comp: PlanningMaintenanceDeleteDialog;
  let fixture: ComponentFixture<PlanningMaintenanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanningMaintenanceDeleteDialog);
