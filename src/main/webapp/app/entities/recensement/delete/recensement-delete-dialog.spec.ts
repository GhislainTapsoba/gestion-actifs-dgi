...
import { RecensementDeleteDialog } from './recensement-delete-dialog';

describe('Recensement Management Delete Component', () => {
  let comp: RecensementDeleteDialog;
  let fixture: ComponentFixture<RecensementDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RecensementDeleteDialog);
