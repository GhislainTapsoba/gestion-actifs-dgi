...
import { TransfertDeleteDialog } from '../delete/transfert-delete-dialog';
...
export class Transfert {
  readonly transferts = signal<ITransfert[]>([]);
  ...
  readonly isLoading = this.transfertService.transfertsResource.isLoading;
  ...
  constructor() {
    effect(() => {
      const headers = this.transfertService.transfertsResource.headers();
      if (headers) {
        this.fillComponentAttributesFromResponseHeader(headers);
      }
    });
    effect(() => {
      this.transferts.set(this.fillComponentAttributesFromResponseBody([...this.transfertService.transferts()]));
    });
    effect(() => {
  ...
  protected fillComponentAttributesFromResponseBody(data: ITransfert[]): ITransfert[] {
    return data;
  }
  ...
  protected queryBackend(): void {
    ...
    this.transfertService.transfertsParams.set(queryObject);
  }
