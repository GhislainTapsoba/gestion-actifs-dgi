...
import { EquipementRecensementDeleteDialog } from './equipement-recensement-delete-dialog';

describe('EquipementRecensement Management Delete Component', () => {
  let comp: EquipementRecensementDeleteDialog;
  let fixture: ComponentFixture<EquipementRecensementDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EquipementRecensementDeleteDialog);
