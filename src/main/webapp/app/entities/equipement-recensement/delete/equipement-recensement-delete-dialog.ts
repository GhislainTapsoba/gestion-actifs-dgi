...
@Component({
  templateUrl: './equipement-recensement-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class EquipementRecensementDeleteDialog {
  equipementRecensement?: IEquipementRecensement;
  ...
  confirmDelete(id: number): void {
    this.equipementRecensementService.delete(id).subscribe(() => {
