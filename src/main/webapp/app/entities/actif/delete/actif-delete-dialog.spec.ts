...
import { ActifDeleteDialog } from './actif-delete-dialog';

describe('Actif Management Delete Component', () => {
  let comp: ActifDeleteDialog;
  let fixture: ComponentFixture<ActifDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ActifDeleteDialog);
