...
export class Actif {
  ...
  constructor() {
    effect(() => {
      const headers = this.actifService.actifsResource.headers();
      if (headers) {
        this.fillComponentAttributesFromResponseHeader(headers);
      }
    });
    effect(() => {
      this.actifs.set(this.fillComponentAttributesFromResponseBody([...this.actifService.actifs()]));
    });
    effect(() => {
  ...
  trackId = (item: IActif): number => this.actifService.getActifIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IActif[]): IActif[] {
    return data;
  }
  ...
  protected queryBackend(): void {
    ...
    this.actifService.actifsParams.set(queryObject);
  }
