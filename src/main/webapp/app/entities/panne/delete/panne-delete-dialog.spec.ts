...
import { PanneDeleteDialog } from './panne-delete-dialog';

describe('Panne Management Delete Component', () => {
  let comp: PanneDeleteDialog;
  let fixture: ComponentFixture<PanneDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PanneDeleteDialog);
