...
import { HistoriqueActionDeleteDialog } from './historique-action-delete-dialog';

describe('HistoriqueAction Management Delete Component', () => {
  let comp: HistoriqueActionDeleteDialog;
  let fixture: ComponentFixture<HistoriqueActionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(HistoriqueActionDeleteDialog);
