...
import { InventaireDeleteDialog } from './inventaire-delete-dialog';

describe('Inventaire Management Delete Component', () => {
  let comp: InventaireDeleteDialog;
  let fixture: ComponentFixture<InventaireDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(InventaireDeleteDialog);
