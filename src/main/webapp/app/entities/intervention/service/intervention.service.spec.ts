...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../intervention.test-samples';
...
describe('Intervention Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Intervention', () => {
      ...
      service.create(intervention).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Intervention', () => {
      ...
      service.update(intervention).subscribe(resp => (expectedResult = resp));
    ...
    describe('addInterventionToCollectionIfMissing', () => {
      it('should add a Intervention to an empty array', () => {
        ...
        expect(expectedResult).toEqual([intervention]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([intervention, intervention2]);
      });
