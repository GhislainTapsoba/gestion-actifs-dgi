...
/**
 * Criteria class for the {@link com.dgi.gestionactifs.domain.Agent} entity. This class is used
 * in {@link com.dgi.gestionactifs.web.rest.AgentResource} to receive all the possible filtering options from
...
public class AgentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nom, prenom, serviceId, utilisateurId, distinct);
    }
