...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: 'a536fde0-6f38-4678-b5b5-f117c3de69ce' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'gestionActifsDgiApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('73f287e7-7cc1-4d35-acf8-4b60eabd4455');
      cy.get(`[data-cy="name"]`).should('have.value', '73f287e7-7cc1-4d35-acf8-4b60eabd4455');
